...
//static const float focuscolor[]            = COLOR(0xb16286ff);
//static const float urgentcolor[]           = COLOR(0xff0000ff);
static const int showbar                   = 1; /* 0 means no bar */
static const int topbar                    = 1; /* 0 means bottom bar */
//static const char *fonts[]                 = {"monospace:size=12"};
//static const char *fonts[]                 = {"FiraCodeNerdFont:pixelsize=11:antialias=true:autohint=true"};
...
static uint32_t colors[][3]                = {
	...
	[SchemeSel]  = { 0xeeeeeeff, 0xb16286ff, 0xb16286ff },
...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_d,           spawn,            {.v = (const char*[]){"passmenu", NULL} } },
	{ MODKEY,                    XKB_KEY_Return,      spawn,            {.v = termcmd} },
	{ MODKEY,                    XKB_KEY_w,           spawn,            {.v = browsercmd} },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_w,           spawn,            {.v = (const char*[]){BROWSER, "--private-window", NULL} } },
	{ MODKEY,                    XKB_KEY_e,           spawn,            {.v = (const char*[]){"thunderbird", NULL} } },
	{ MODKEY,                    XKB_KEY_r,           spawn,            {.v = (const char*[]){TERMINAL, "lf", NULL} } },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_n,           spawn,            {.v = (const char*[]){TERMINAL, "newsboat", NULL} } },
	{ MODKEY,                    XKB_KEY_p,           spawn,            {.v = (const char*[]){"rmpc", "togglepause", NULL} } },
	...
	{ MODKEY,                    XKB_KEY_braceleft,   spawn,            {.v = (const char*[]){"rmpc", "prev", NULL} } },
	{ MODKEY,                    XKB_KEY_braceright,  spawn,            {.v = (const char*[]){"rmpc", "next", NULL} } },
	{ MODKEY,                    XKB_KEY_m,           spawn,            {.v = (const char*[]){TERMINAL, "rmpc", NULL} } },
